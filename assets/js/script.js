    ...
    h.innerHTML = `<header>
      <div class="wrap nav">
        ...
        <a class="brand" href="index.html">
          <img src="assets/images/naya-logo.png"
               alt="Nanumba Youth Association Logo"
               class="naya-logo">

          <strong>
            NAYA
            <small>Nanumba Youth Association</small>
          </strong>
        </a>
        ...
        <nav>
          ${[
            ...
            .map(
              (x) =>
                `<a class="${page === x[0] ? "active" : ""}" href="${x[0]}">${x[1]}</a>`,
            )
            .join("")}
        </nav>
    ...
    f.innerHTML = `<footer>
      <div class="wrap foot">
        ...
        <div>
          ...
          <p>
            Promoting development and unity of purpose among the Nanumba people.
          </p>
        </div>
